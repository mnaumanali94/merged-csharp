...
namespace Merged.Standard
{
    public sealed class Configuration
    {
        ...
        public string BatesterBasicAuthUserName { get; }

        // The password to use with basic authentication
        public string BatesterBasicAuthPassword { get; }
        /// <summary>
        /// Http client timeout
        /// </summary>
        ...
        public Builder ToBuilder() 
        {
            Builder builder = new Builder()
                .WithBatesterBasicAuthUserName(BatesterBasicAuthUserName)
                .WithBatesterBasicAuthPassword(BatesterBasicAuthPassword)
        ...
        public class Builder
        {
            ...
            public string BatesterBasicAuthUserName { get; private set; } = "TODO: Replace";
            public string BatesterBasicAuthPassword { get; private set; } = "TODO: Replace";
            ...
            public Builder WithBatesterBasicAuthUserName(string batesterBasicAuthUserName)
            {
                this.BatesterBasicAuthUserName = batesterBasicAuthUserName;
                return this;
            }
            ...
            public Builder WithBatesterBasicAuthPassword(string batesterBasicAuthPassword)
            {
                this.BatesterBasicAuthPassword = batesterBasicAuthPassword;
                return this;
            }
            ...
            public Configuration Build()
            {
                ...
                return new Configuration(HttpClient, Timeout, Token, Environment, Port, Suites,BatesterBasicAuthUserName,BatesterBasicAuthPassword);
            }
        }
    }
}